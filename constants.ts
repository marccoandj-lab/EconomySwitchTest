...
const createEconomyTiles = (): TileData[] => [
  ...
  { id: 1, type: TileType.PROFIT, label: "Salary", amount: 50000 },
  { id: 2, type: TileType.QUESTION, label: "Finance Quiz" },
  { id: 3, type: TileType.TAX, label: "Income Tax", amount: 10000 },
  { id: 4, type: TileType.INVESTMENT, label: "Stock Market" },
  { id: 5, type: TileType.ENUM, label: "Financial Terms" },
  { id: 6, type: TileType.PROFIT, label: "Bonus", amount: 70000 },
  ...
  { id: 10, type: TileType.TAX, label: "VAT", amount: 15000 },
  { id: 11, type: TileType.PROFIT, label: "Dividends", amount: 90000 },
  ...
  { id: 15, type: TileType.TAX, label: "Fine", amount: 5000 },
  { id: 16, type: TileType.QUESTION, label: "Sustainability" },
  { id: 17, type: TileType.INVESTMENT, label: "Funds" },
  { id: 18, type: TileType.PROFIT, label: "Lottery", amount: 250000 },
  { id: 19, type: TileType.ENUM, label: "Markets" },
  { id: 20, type: TileType.TAX, label: "Property Tax", amount: 30000 },
  { id: 21, type: TileType.SWITCH, label: "SWITCH" },
  { id: 22, type: TileType.PROFIT, label: "Freelance", amount: 40000 },
  { id: 23, type: TileType.QUESTION, label: "Banking" },
  { id: 24, type: TileType.INVESTMENT, label: "Crypto" },
  { id: 25, type: TileType.TAX, label: "Luxury Tax", amount: 20000 },
  { id: 26, type: TileType.ENUM, label: "Trade" },
  { id: 27, type: TileType.PROFIT, label: "Grant", amount: 60000 },
];

const createSustainabilityTiles = (): TileData[] => [
  { id: 0, type: TileType.START, label: "NATURE START" },
  { id: 1, type: TileType.PROFIT, label: "Solar Refund", amount: 60000 },
  { id: 2, type: TileType.QUESTION, label: "Nature Quiz" },
  { id: 3, type: TileType.TAX, label: "Carbon Tax", amount: 10000 },
  { id: 4, type: TileType.INVESTMENT, label: "Green Bonds" },
  { id: 5, type: TileType.ENUM, label: "Renewables" },
  { id: 6, type: TileType.PROFIT, label: "Solar Export", amount: 35000 },
  { id: 7, type: TileType.SWITCH, label: "SWITCH" },
  { id: 8, type: TileType.PROFIT, label: "Circular Grant", amount: 80000 },
  { id: 9, type: TileType.QUESTION, label: "Ecosystems" },
  { id: 10, type: TileType.TAX, label: "Pollution Fine", amount: 25000 },
  { id: 11, type: TileType.INVESTMENT, label: "Wind Farm" },
  { id: 12, type: TileType.PROFIT, label: "Recycling Hub", amount: 55000 },
  { id: 13, type: TileType.ENUM, label: "Wildfire Prev" },
  { id: 14, type: TileType.JAIL, label: "JAIL" },
  { id: 15, type: TileType.TAX, label: "Waste Fee", amount: 10000 },
  { id: 16, type: TileType.QUESTION, label: "Climate Change" },
  { id: 17, type: TileType.INVESTMENT, label: "Reforestation" },
  { id: 18, type: TileType.PROFIT, label: "EU Subsidy", amount: 300000 },
  { id: 19, type: TileType.ENUM, label: "Conservation" },
  { id: 20, type: TileType.TAX, label: "Water Tax", amount: 15000 },
  { id: 21, type: TileType.SWITCH, label: "SWITCH" },
  { id: 22, type: TileType.INVESTMENT, label: "Eco-Tech" },
  { id: 23, type: TileType.QUESTION, label: "Bio Diversity" },
  { id: 24, type: TileType.PROFIT, label: "Organic Yield", amount: 45000 },
  { id: 25, type: TileType.TAX, label: "Soil Depletion", amount: 20000 },
